...
FlipBook.prototype = {
	...
	,removeBookmark: function(pageNum) {
		...
		while(_g1 < _g) {
			var i1 = _g1++;
			haxe.Log.trace(RunTime.book.bookmarks[i1].pageNum,{ fileName : "FlipBook.hx", lineNumber : 2048, className : "FlipBook", methodName : "removeBookmark"});
	...
	,onTouchMove: function(e) {
		...
		if(this.zoomStatus == core.ZoomStatus.zoomed && this.startMoveGesture) {
			...
			haxe.Log.trace(this.zoom.style.cssText,{ fileName : "FlipBook.hx", lineNumber : 1500, className : "FlipBook", methodName : "onTouchMove"});
	...
	,pointDown: function(e) {
		var obj = e;
		haxe.Log.trace("pointDown",{ fileName : "FlipBook.hx", lineNumber : 395, className : "FlipBook", methodName : "pointDown"});
		if(this.isTouch) this.maskGesture.addPointer(obj.pointerId);
		this.downPointCount++;
	...
	,attachActions: function() {
		...
		try {
			...
			js.Lib.window.document.title = "! need touch screen devices";
		}
...
core.HtmlHelper.toPopupImageHtml = function(item,success) {
	...
	if(item.popupWidth != null && item.popupHeight != null) {
		...
		s += "</div>";
		haxe.Log.trace(s,{ fileName : "HtmlHelper.hx", lineNumber : 376, className : "core.HtmlHelper", methodName : "toPopupImageHtml"});
	} else {
		s = "";
